...
class CrossbarAXIWrapper extends Module {
    ...
    val io=IO(new Bundle {
        ...
        val outs = Flipped(Vec(Crossbar.numberOfOutputs, new AXI4FullReadOnly(UInt(Crossbar.reqDataWidth.W), Crossbar.outAddrWidth, Crossbar.outIdWidth)))
    })
